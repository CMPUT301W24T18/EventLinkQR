...
/**
 * Fragment for the list of attendees that have checked in to the event
 */
public class CheckedAttendeesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String [] attendees = {"checked attendees", "checked attendees", "checked attendees", "checked attendees", "checked attendees", "checked attendees",
                "checked attendees", "checked attendees", "checked attendees", "checked attendees"};
