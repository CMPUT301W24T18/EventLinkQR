...
//         // Assuming `notifications` is an array inside `notificationData`
//         // and you need the last element for the heading and description.
//         const lastNotification = notificationData.notifications[notificationData.notifications.length - 1];

//         console.log('The heading of notification is ' + lastNotification.heading);
//         console.log('The description of notification is ' + lastNotification.description);
